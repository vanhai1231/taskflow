          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <ScrollReveal key={i} delay={i * 150}>
                <div className="group rounded-2xl border bg-card p-8 h-full transition-all duration-500 hover:border-foreground/20 hover:shadow-2xl hover:shadow-white/5 hover:-translate-y-1">
